  ...
  return (
    <div>
      <h2 id="request-heading" data-cy="RequestHeading">
        <Translate contentKey="goodpeopleApp.request.home.title">Requests</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="goodpeopleApp.request.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/request/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="goodpeopleApp.request.home.createLabel">Create new Request</Translate>
          </Link>
        </div>
      </h2>
        ...
        {requestList && requestList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="goodpeopleApp.request.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('requestType')}>
                  <Translate contentKey="goodpeopleApp.request.requestType">Request Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('startLocation')}>
                  <Translate contentKey="goodpeopleApp.request.startLocation">Start Location</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('destination')}>
                  <Translate contentKey="goodpeopleApp.request.destination">Destination</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('numberOfSeatsRequested')}>
                ...
                <th className="hand" onClick={sort('product')}>
                  <Translate contentKey="goodpeopleApp.request.product">Product</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('deliveryLocation')}>
                  <Translate contentKey="goodpeopleApp.request.deliveryLocation">Delivery Location</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="goodpeopleApp.request.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="goodpeopleApp.request.requester">Requester</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="goodpeopleApp.request.trip">Trip</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {requestList.map((request, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`goodpeopleApp.RequestType.${request.requestType}`} />
                  </td>
                  <td>{request.startLocation}</td>
                  <td>{request.destination}</td>
                  <td>{request.numberOfSeatsRequested}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="goodpeopleApp.request.home.notFound">No Requests found</Translate>
            </div>
          )
        )}
      </div>
