...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './request.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUEST_LIST actions', async () => {
    ...
    it('dispatches FETCH_REQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REQUEST actions', async () => {
      const expectedActions = [
        {
